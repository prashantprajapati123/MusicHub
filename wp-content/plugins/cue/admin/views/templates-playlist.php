	...
	<div class="cue-track-inside">
		...
		<div class="cue-track-column-group">
			...
			<div class="cue-track-column cue-track-column-left">
				...
				<p>
					<label>
						<?php esc_html_e( 'Categories:', 'cue' ); ?><br>
						<input type="text" name="tracks[][categories]" placeholder="<?php esc_attr_e( 'Categories', 'cue' ); ?>" value="{{{ data.categories }}}" data-setting="categories" class="regular-text">
					</label>
				</p>
				<!-- Added by vinay end-->
